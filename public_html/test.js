...
function zalozOtazky() {
	...
	pridejOtazku(
		...
		"Součást W3C konsorcia",
		"Sdružení pro internetovou reklamu",
		"Knihovna PHP",
		"Knihovna JavaScriptu",
		"Runtime pro mySQL",
		"",
		"",
		"",
		...
		"vybiraci");
	pridejOtazku(
		"Co to je admonitoring?",
		"Měření výdajů do internetového marketingu",
		"Sledování spouštěných reklam na webových stránkách",
		"Sledování pohybu návštěvníků pro reklamní účely",
		"Měření příjmů z internetového marketingu",
		"Jednotné měření návštěvnosti",
		"",
		"",
		"",
		"",
	...
	pridejOtazku(
		"K čemu je Node.js?",
		"Pro aplikace s hodně I/O operacemi, real-time zpracování",
		"Knihovna PHP",
		"Zefektivnění skriptů na serveru",
		"Nástroj pro tvorbu interaktivních her",
		"Nástupce Javascriptu",
		"",
		"",
		"",
		"",
		...
		"vybiraci");
	pridejOtazku(
		"Nejhustší připojení k internetu",
		"Západní Evropa",
		"Asie",
		"Východní Evropa (lol)",
		"Střední Evropa",
	...
	pridejOtazku(
		...
		"vybiraci");
	pridejOtazku(
		"národní domény výhradně pro USA",
		".net",
		".org",
		".com",
		".gov",
	...
	pridejOtazku(
		...
		"Pronájem prostoru pro webové stránky na WWW serveru",
		"",
		"",
		"základní typ webhostingu, kde uživatel provozuje jednu doménu 2. řádu",
		"vybiraci");
